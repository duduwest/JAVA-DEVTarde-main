...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            Connection c = DriverManager.getConnection(url, usuario, senha); // TEM Q SER NESSA ORDEM URL,USUARIO,SENHA // Estabelece a conexão com o banco de dados.
            ...
            s.executeQuery("INSERT INTO CONTATO VALUES('2', 'duduwest', 'edujujunior@gmail.com')"); 
